...
public class Body {
    ...
    public static final String CREATE_CALLEE_GET="{\r\n"
	    ...
	    + "_:BN000000 ns2:presentedBy <"+PREFIX+"serverOf"+ID+"> ;\\r\\n"
	    + "  a ns:Profile ;\\r\\n"
	    + "  ns:has_process <"+PREFIX+"serverOf"+ID+"Process> ;\\r\\n"
	    + "  ns:hasResult [\\r\\n"
	    + "    ns1:withOutput (\\r\\n"
	    + "      [\\r\\n"
	    + "        a ns1:OutputBinding ;\\r\\n"
	    ...
	    + "    ns3:Device ,\\r\\n"
	    + "    ns3:PhysicalThing .\\r\\n"
	    + "<"+PREFIX+"serverOf"+ID+"> a ns3:DeviceService ;\\r\\n"
    ...
    public static final String CREATE_CALLEE_GETVALUE="{\r\n"
	    ...
	    + "    ns4:Device ,\\r\\n"
	    + "    ns4:PhysicalThing .\\r\\n"
	    + "<"+PREFIX+"serverOf"+ID+"> a ns4:DeviceService ;\\r\\n"
	    + "  pvn:instanceLevelRestrictions (\\r\\n"
	    + "    [\\r\\n"
	    + "      :hasValue <"+PREFIX+ID+"> ;\\r\\n"
	    + "      a :Restriction ;\\r\\n"
