...
public class Body {
    ...
    public static final String CALL_GETALLDEVICES_CHE=CALL_QUERY.replace(QUERY, QUERYDEVICES);
    public static final String CALL_GETALLDEVICES_BUS=
	    ...
	    + "	@prefix ns3: <http://www.daml.org/services/owl-s/1.1/Profile.owl#> ."
	    + "	@prefix : <http://ontology.universAAL.org/Workbench.owl#> ."
	    + "	_:BN000000 a pvn:ServiceRequest ;"
	    + "	  pvn:requiredResult ["
	    + "	    ns2:withOutput ("
	    ...
	    + "	    ["
	    + "	      a owl:Restriction ;"
	    + "	      owl:allValuesFrom ns1:Device ;"
	    + "	      owl:onProperty ns1:controls"
	    + "	    ]"
	    + "	  ) ;"
	    + "	  ns:presents ["
	    + "	    ns:presentedBy :serviceX ;"
	    + "	    a ns3:Profile ;"
	    + "	    ns3:has_process :serviceXProcess"
	    + "	  ] ."
